...
dorothy = User.create(username: "dorothy.vaughan", password: "abc123")
sandi = User.create(username: "sandi.metz", password: "abc123")
alan = User.create(username: "alan.turing", password: "abc123")
grace = User.create(username: "grace.hopper", password: "abc123")
